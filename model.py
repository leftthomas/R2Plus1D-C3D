...
class MNISTCapsuleNet(nn.Module):
    def __init__(self):
        ...
        self.classifier = CapsuleLinear(in_capsules=4 * 4 * 32 // self.out_length, out_capsules=10,
                                        in_length=self.out_length, out_length=8)
...
class FashionMNISTCapsuleNet(nn.Module):
    def __init__(self):
        ...
        self.out_length = 16
        self.features = nn.Sequential(
            CapsuleConv2d(in_channels=1, out_channels=16, kernel_size=7, in_length=1, out_length=4, stride=1,
                          padding=3),
            CapsuleConv2d(in_channels=16, out_channels=16, kernel_size=3, in_length=4, out_length=4, stride=2,
                          padding=1),
            CapsuleConv2d(in_channels=16, out_channels=32, kernel_size=3, in_length=4, out_length=8, stride=1,
...
class STL10CapsuleNet(nn.Module):
    def __init__(self):
        ...
        self.out_length = 16
        self.features = nn.Sequential(
            CapsuleConv2d(in_channels=3, out_channels=16, kernel_size=5, in_length=1, out_length=4, stride=2,
                          padding=2),
            CapsuleConv2d(in_channels=16, out_channels=16, kernel_size=5, in_length=4, out_length=4, stride=2,
                          padding=2),
