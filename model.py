...
class CIFAR10CapsuleNet(nn.Module):
    def __init__(self):
        ...
        self.classifier = nn.Sequential(
            CapsuleLinear(in_capsules=4 * 4 * 64 // self.out_length, out_capsules=32, in_length=self.out_length,
                          out_length=16),
            CapsuleLinear(in_capsules=32, out_capsules=10, in_length=16, out_length=16))
