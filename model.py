    ...
    def __init__(self):
        ...
        self.features = nn.Sequential(
            ...
            CapsuleConv2d(in_channels=64, out_channels=128, kernel_size=3, in_length=8, out_length=8, stride=1,
                          padding=1),
            CapsuleConv2d(in_channels=128, out_channels=128, kernel_size=3, in_length=16, out_length=8, stride=2,
                          padding=1),
        ...
        self.classifier = CapsuleLinear(in_capsules=2 * 2 * 256 // 16, out_capsules=10, in_length=16, out_length=16)
...
class CIFAR10CapsuleNet(nn.Module):
    def __init__(self):
        ...
        self.features = nn.Sequential(
            ...
            CapsuleConv2d(in_channels=256, out_channels=256, kernel_size=3, in_length=16, out_length=16, stride=2,
                          padding=1),
            CapsuleConv2d(in_channels=256, out_channels=512, kernel_size=3, in_length=16, out_length=16, stride=1,
                          padding=1),
            CapsuleConv2d(in_channels=512, out_channels=512, kernel_size=3, in_length=16, out_length=16, stride=1,
                          padding=1),
            CapsuleConv2d(in_channels=512, out_channels=512, kernel_size=3, in_length=16, out_length=16, stride=2,
                          padding=1)
        )
        self.classifier = CapsuleLinear(in_capsules=2 * 2 * 512 // 16, out_capsules=10, in_length=16, out_length=16)
