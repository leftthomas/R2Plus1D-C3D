...
config = {
    ...
    'SVHN': ['32-8', '32-8D', '64-16', '64-16D', '128-32', '128-32D', '256-64', '256-64D'],
    'CIFAR10': ['32-8', '32-8D', '64-16', '64-16D', '128-32', '128-32D', '256-64', '256-64D'],
    'CIFAR100': ['32-8', '32-8D', '64-16', '64-16D', '128-32', '128-32D', '256-64', '256-64D'],
...
class SquashCapsuleNet(nn.Module):
    def __init__(self, in_channels, num_class, data_type):
        ...
        self.classifier = CapsuleLinear(in_capsules=2 * 2 * 256 // 64, out_capsules=num_class, in_length=64,
                                        out_length=64)
