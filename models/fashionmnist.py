...
class FashionMNISTCapsuleNet(nn.Module):
    def __init__(self):
        ...
        self.features = nn.Sequential(
            ...
            CapsuleConv2d(in_channels=32, out_channels=64, kernel_size=5, in_length=4, out_length=4, stride=2,
                          padding=0),
            nn.BatchNorm2d(num_features=64),
            nn.ReLU(inplace=True),
            CapsuleConv2d(in_channels=64, out_channels=128, kernel_size=3, in_length=4, out_length=self.out_length,
                          stride=2,
                          padding=1),
