...
class MNISTCapsuleNet(nn.Module):
    def __init__(self, routing_type='sum'):
        ...
        self.features = nn.Sequential(
            CapsuleConv2d(in_channels=1, out_channels=64, kernel_size=3, in_length=1, out_length=4, stride=2,
                          padding=1),
        ...
        self.classifier = nn.Sequential(
            CapsuleLinear(in_capsules=4 * 4 * 256 // self.features_out_length, out_capsules=64,
