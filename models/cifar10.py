...
class CIFAR10CapsuleNet(nn.Module):
    def __init__(self):
        ...
        self.features = nn.Sequential(
            CapsuleConv2d(in_channels=3, out_channels=8, kernel_size=3, in_length=1, out_length=4, stride=1,
                          padding=1),
            nn.BatchNorm2d(num_features=8),
            nn.ReLU(inplace=True),
            CapsuleConv2d(in_channels=8, out_channels=8, kernel_size=3, in_length=4, out_length=4, stride=2,
                          padding=1),
            nn.BatchNorm2d(num_features=8),
            nn.ReLU(inplace=True),
        ...
        self.classifier = CapsuleLinear(in_capsules=2 * 2 * 32 // self.out_length, out_capsules=10,
