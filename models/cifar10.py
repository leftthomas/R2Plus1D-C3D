...
class CIFAR10CapsuleNet(nn.Module):
    def __init__(self, with_routing=False):
        ...
        self.features = nn.Sequential(
            CapsuleConv2d(in_channels=3, out_channels=32, kernel_size=5, in_length=1, out_length=4, stride=1,
                          padding=2, with_routing=with_routing),
            nn.BatchNorm2d(num_features=32),
            nn.ReLU(inplace=True),
            CapsuleConv2d(in_channels=32, out_channels=64, kernel_size=3, in_length=4, out_length=4, stride=2,
